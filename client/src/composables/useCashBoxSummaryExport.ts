...
const HEADERS = ['Order No', 'Order Created Date', 'Business Date', 'Customer', 'Total Amount', 'Discount', 'Order Amount After Discount', 'Due Amount', 'Payment Method', 'Payment Received']
...
function buildFlatRows(rawRows: CashBoxSummaryRow[]): string[][] {
  return rawRows.map((row) => [
    ...
    row.orderAmountAfterDiscount.toFixed(2),
