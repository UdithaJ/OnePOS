  ...
  <div class="report-page">
    ...
    <div class="report-header-bar">
      <div class="flex items-center gap-3">
        ...
        <h2 class="text-2xl font-semibold text-gray-900">Bank Transfer Reconciliation</h2>
      </div>
    ...
    <v-alert
      ...
      class="mt-4"
    >
      No bank deposit records found for the selected date range.
    </v-alert>
        ...
        <table class="report-table">
          ...
          <tfoot>
            <tr class="grand-total-row">
              <td colspan="2" class="grand-total-label">Total Reconcile Value</td>
              <td class="grand-total-value">{{ totalReconcileValue.toLocaleString() }}</td>
            </tr>
          </tfoot>
        </table>
      </div>
...
import { useBankReconciliationReport } from '@/composables/useBankReconciliationReport'
import { useBankReconciliationExport } from '@/composables/useBankReconciliationExport'

const { fromDate, toDate, rawRows, tableRows, totalReconcileValue, loading, errorMsg, hasSearched, fetchReport } = useBankReconciliationReport()
const { exportToExcel, exportToPDF, exportToCSV } = useBankReconciliationExport()
